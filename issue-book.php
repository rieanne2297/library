 ...
 <?php
	if( isset($error) ){
		switch($error){
			...
			case 1212: 
				echo"<script>swal('Success!', 'Request Rejected!', 'success')</script>";
				break;
			case 1313: 
				echo"<script>swal('Success!', 'Request Approved!', 'success')</script>";
				break;	
			case 00: 
    ...
    <nav class="navbar navbar-default" style="background-color:#751816; padding: 20px; ">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="http://localhost/library/controller.php?page=getids" style="color: white; font-size: 18px;"><i class="fa fa-align-justify"></i>&nbsp;Issue a Book</a></li>
...
<div class="container" style="background-color: #fff;">
		...
		<div class="card">
			<div class="card-body">
				<h4><i class="fa fa-book"></i><b>&nbsp;Issue a Book</b></h4> 
			</div>
		</div>
		<br /><br />
		
		<form action="controller.php?page=getreqinfo" method="post">
		<div class="container">
		<div class="row">
		<div class="col-sm-10 col-centered" style="padding: 50px;">
			...
			<br />
		<form action="controller.php?page=approval_borrow" method="post">
		<div class="form-group row">
		...
		<input type="submit" onclick="myFunction2()"  value="REJECT" name="reject" class="btn btn-primary btn-danger" ></input>
